...
const translations: Translations = {
  ...
  'nav.organizations': { fa: 'چارت سازمانی', en: 'Organizations' },
  ...
  'resources.edit': { fa: 'ویرایش منبع', en: 'Edit Resource' },
  'resources.name': { fa: 'نام', en: 'Name' },
  'resources.firstName': { fa: 'نام', en: 'First Name' },
  'resources.lastName': { fa: 'نام خانوادگی', en: 'Last Name' },
  'resources.email': { fa: 'ایمیل', en: 'Email' },
  'resources.phoneNumber': { fa: 'شماره تماس', en: 'Phone Number' },
  'resources.type': { fa: 'نوع', en: 'Type' },
  'resources.type.employee': { fa: 'کارمند', en: 'Employee' },
  'resources.type.contractor': { fa: 'پیمانکار', en: 'Contractor' },
  'resources.type.equipment': { fa: 'تجهیزات', en: 'Equipment' },
  'resources.type.material': { fa: 'مواد', en: 'Material' },
  'resources.type.cost': { fa: 'هزینه', en: 'Cost' },
  'resources.status': { fa: 'وضعیت', en: 'Status' },
  'resources.status.active': { fa: 'فعال', en: 'Active' },
  'resources.status.inactive': { fa: 'غیرفعال', en: 'Inactive' },
  'resources.status.onLeave': { fa: 'مرخصی', en: 'On Leave' },
  'resources.standardRate': { fa: 'نرخ استاندارد', en: 'Standard Rate' },
  'resources.overtimeRate': { fa: 'نرخ اضافه‌کاری', en: 'Overtime Rate' },
  'resources.totalResources': { fa: 'کل منابع', en: 'Total Resources' },
  'resources.activeResources': { fa: 'منابع فعال', en: 'Active Resources' },
  'resources.employees': { fa: 'کارمندان', en: 'Employees' },
  'resources.search': { fa: 'جستجو در منابع...', en: 'Search resources...' },
  'resources.allTypes': { fa: 'همه انواع', en: 'All Types' },
  'resources.allStatuses': { fa: 'همه وضعیت‌ها', en: 'All Statuses' },
  'resources.noResources': { fa: 'منبعی یافت نشد', en: 'No resources found' },
  'resources.createNew': { fa: 'ایجاد منبع جدید', en: 'Create New Resource' },
  'resources.manageResources': { fa: 'مدیریت منابع انسانی و مادی پروژه', en: 'Manage human and material project resources' },
  'resources.calendarViewComingSoon': { fa: 'نمای تقویمی به زودی اضافه خواهد شد', en: 'Calendar view coming soon' },
  'resources.loadError': { fa: 'خطا در بارگذاری منابع', en: 'Failed to load resources' },
  'resources.createSuccess': { fa: 'منبع با موفقیت ایجاد شد', en: 'Resource created successfully' },
  'resources.createError': { fa: 'خطا در ایجاد منبع', en: 'Failed to create resource' },
  'resources.updateSuccess': { fa: 'منبع با موفقیت به‌روزرسانی شد', en: 'Resource updated successfully' },
  'resources.updateError': { fa: 'خطا در به‌روزرسانی منبع', en: 'Failed to update resource' },
  'resources.deleteSuccess': { fa: 'منبع با موفقیت حذف شد', en: 'Resource deleted successfully' },
  'resources.deleteError': { fa: 'خطا در حذف منبع', en: 'Failed to delete resource' },
  'resources.deleteConfirm': { fa: 'آیا مطمئن هستید که می‌خواهید این منبع را حذف کنید؟', en: 'Are you sure you want to delete this resource?' },
  'resources.unknown': { fa: 'نامشخص', en: 'Unknown' },
  'resources.maxUnits': { fa: 'حداکثر واحد', en: 'Max Units' },
  'resources.manager': { fa: 'مدیر', en: 'Manager' },
  'resources.selectManager': { fa: 'انتخاب مدیر', en: 'Select Manager' },
  'resources.noManager': { fa: 'بدون مدیر', en: 'No Manager' },
  'resources.perHour': { fa: '/ساعت', en: '/hr' },
  'resources.status.terminated': { fa: 'خاتمه یافته', en: 'Terminated' },
  'resources.maxUnitsPercent': { fa: 'حداکثر واحد (%)', en: 'Max Units (%)' },
  'resources.rialPerHour': { fa: 'ریال/ساعت', en: 'Rial/hr' },
  'resources.notAssigned': { fa: 'اختصاص داده نشده', en: 'Not Assigned' },
  ...
  'projects.organization': { fa: 'سازمان/دپارتمان', en: 'Organization/Department' },
  'projects.selectOrganization': { fa: 'انتخاب سازمان', en: 'Select Organization' },
  'projects.center': { fa: 'مرکز (اختیاری)', en: 'Center (Optional)' },
  'projects.centerPlaceholder': { fa: 'نام مرکز را وارد کنید', en: 'Enter center name' },
